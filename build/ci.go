...
import (
	...
	"github.com/codecodeorg/opgeth/crypto/signify"
	"github.com/codecodeorg/opgeth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/codecodeorg/opgeth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/codecodeorg/opgeth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/codecodeorg/opgeth/params.gitTag="+env.Tag)
	}
